...
import com.example.tutorpet.DateUtils
import com.example.tutorpet.R
import com.example.tutorpet.model.Message
import kotlinx.android.synthetic.main.item_minha_mensagem.view.*
import kotlinx.android.synthetic.main.item_outra_mensagem.view.*
...
class MessageAdapter (val context: Context) : RecyclerView.Adapter<MessageViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MessageViewHolder {
        return if(viewType == VIEW_TYPE_MY_MESSAGE) {
            MyMessageViewHolder(LayoutInflater.from(context).inflate(R.layout.item_minha_mensagem, parent, false))
        } else {
            OtherMessageViewHolder(LayoutInflater.from(context).inflate(R.layout.item_outra_mensagem, parent, false))
        }
    }
